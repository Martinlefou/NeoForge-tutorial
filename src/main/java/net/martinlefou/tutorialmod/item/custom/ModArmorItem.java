package net.martinlefou.tutorialmod.item.custom;
import com.google.common.collect.ImmutableMap;
import net.martinlefou.tutorialmod.item.ModArmorMaterials;
            ...
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.BISMUTH_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.JUMP, 200, 1, false, false),
                                    new MobEffectInstance(MobEffects.DIG_SPEED, 200, 1, false, false),
